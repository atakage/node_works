...
/*
    ...
    이 모듈을 사용하는 곳에서 어떤 값을 매개변수로 전달하고자 할 때 사용하는 코드
*/

// ==  module.exports = function(){}

// ()=>{}  화살표 함수 ESS 이상에서 사용할 수 있는 단축형 함수
// 변수 scope에 상당히 민감, 특히 this라는 키워드의 변수는 scope 때문에 사용하면서 많은 테스트를 수행해야 함
// 이유는 function방식의 함수와는 다르게 작동되기 때문
module.exports = (app)=>{
